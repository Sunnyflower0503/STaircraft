...
tests = {@test_actuator_from_servo_output_raw, @test_user_hitl_config, @test_apply_user_initial_conditions, @test_prepare_stand_static_for_hitl, @test_initial_geodetic_position, @test_state_to_uavdata_like, ...
